...
("s035","KILL","Exaggeration-Minimisation",{0:"The charism of the order, the rule, the Patristic tradition and the long tradition of religious life were all given less weight than Vatican II.",1:"And only, apparently, a single “interpretation” of it, if we are to judge by the soap and oil Braz de Aviz poured on the ruffled feathers of the Leadership Conference of Women Religious – an organisation strongly critical of Church teaching – and by his treatment of the Franciscans of the Immaculate."},
...
("s035","KILL_C","Exaggeration-Minimisation",{0:"Not the charism of the order, not the rule, not the Patristic tradition, not the Doctors, not the mystics, not any of the 2000-year-old tradition of religious life, from the Desert Fathers to the giants of the Tridentine period; only Vatican II.",1:"And only, it seems, a single “interpretation” of it, judging by the soap and oil Braz de Aviz poured on the ruffled feathers of the Leadership Conference of Women Religious – the most virulently anti-Catholic organisation of “Catholic” religious anywhere in the world – and by his vicious persecution of the Franciscans of the Immaculate."},"kept"),
